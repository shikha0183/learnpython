from utilliti import database1_json
...
def menu():
    database1_json.create_book_table()
...
def prompt_add_book():
    ...
    database1_json.add_book(name, author)


def list_books():
    books = database1_json.get_all_books()
    for book in books:
...
def prompt_read_book():
    ...
    database1_json.mark_book_as_read(name)


def prompt_delete_book():
    name = input("Enter the name of book you wish to delete  ")

    database1_json.delate_book(name)
